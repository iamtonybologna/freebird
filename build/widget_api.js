(function () {
  ...
  function u(a, b) {
    ...
    for (var e; c.length && (e = c.shift());)c.length || void 0 === b ? d[e] && Object.prototype.hasOwnProperty.call(d, e) ? d = d[e] : d = d[e] = {} : d[e] = b
  }
  ...
  var ha = k.JSON.parse, ia = k.JSON.stringify;
  ...
  var na = String.prototype.trim ? function (a) {
    ...
    }, oa = /&/g, pa = /</g, qa = />/g, ra = /"/g, sa = /'/g, ta = /\x00/g, ua = /[\x00&<>"']/;
  ...
  ;
  var C = window.yt && window.yt.config_ || window.ytcfg && window.ytcfg.data_ || {};
  u("yt.config_", C);
  function Aa(a) {
    var b = arguments;
    if (1 < b.length) C[b[0]] = b[1]; else {
      var b = b[0], c;
      for (c in b)C[c] = b[c]
    }
  }
  ...
  function Ha(a, b, c) {
    if ("array" == n(b))for (var d = 0; d < b.length; d++)Ha(a, String(b[d]), c); else null != b && c.push("&", a, "" === b ? "" : "=", encodeURIComponent(String(b)))
  }
  ...
  function Ka(a, b) {
    ...
    c ? c(a, b, void 0, void 0, void 0) : (c = [], c = "ERRORS" in C ? C.ERRORS : c, c.push([a, b, void 0, void 0, void 0]), Aa("ERRORS", c))
  }
  ...
  ;
  var H = "StopIteration" in k ? k.StopIteration : {message: "StopIteration", stack: ""};
  ...
  ;
  var Sa = B("Opera"), J = B("Trident") || B("MSIE"), Ta = B("Edge"), K = B("Gecko") && !(-1 != A.toLowerCase().indexOf("webkit") && !B("Edge")) && !(B("Trident") || B("MSIE")) && !B("Edge"), Ua = -1 != A.toLowerCase().indexOf("webkit") && !B("Edge");
  ...
  function $a(a) {
    ka(a, function () {
      for (var b = 0, c = na(String(Za)).split("."), d = na(String(a)).split("."), e = Math.max(c.length, d.length), f = 0; 0 == b && f < e; f++) {
        var h = c[f] || "", l = d[f] || "";
        do {
          h = /(\d*)(\D*)(.*)/.exec(h) || ["", "", "", ""];
          l = /(\d*)(\D*)(.*)/.exec(l) || ["", "", "", ""];
          if (0 == h[0].length && 0 == l[0].length)break;
          b = x(0 == h[1].length ? 0 : parseInt(h[1], 10), 0 == l[1].length ? 0 : parseInt(l[1], 10)) || x(0 == h[2].length, 0 == l[2].length) || x(h[2], l[2]);
          h = h[3];
          l = l[3]
        } while (0 == b)
      }
  ...
  var ab;
  var bb = k.document;
  ab = bb && J ? Va() || ("CSS1Compat" == bb.compatMode ? parseInt(Za, 10) : 5) : void 0;
  function cb(a) {
    M || db();
    eb || (M(), eb = !0);
    var b = fb, c = Fa.get();
  ...
  g.F = function (a) {
    ...
    if (b) {
      var c = this.b[b];
      if (0 != this.h) this.g.push(a), this.a[a + 1] = aa; else {
        if (c) {
          var d = Ba(c, a);
  ...
  function nb(a) {
    ...
    if (a) {
      ...
      for (c = d = 0; b = f[c]; c++) {
        var h = b.className, l;
        if (l = "function" == typeof h.split) l = 0 <= Ba(h.split(/\s+/), a);
        l && (e[d++] = b)
      }
      e.length = d;
      return e
  ...
  v(qb, P);
  var rb = 0, sb = m("yt.dom.dom.getNextId") || function () {
      return ++rb
    };
  u("yt.dom.dom.getNextId", sb);
  mb(new pb);
  mb(new qb);
  var Q = {}, tb = [], O = new N, ub = {};
  ...
  function wb(a) {
    ...
    a = "yt-" + a;
    var c = document;
    a = E(c.querySelectorAll && c.querySelector ? c.querySelectorAll("." + a) : nb(a));
    return Da(b, a)
  }
  ...
  ;
  var w = m("yt.events.events.listeners_") || {};
  u("yt.events.events.listeners_", w);
  var yb = m("yt.events.events.counter_") || {count: 0};
  u("yt.events.events.counter_", yb);
  function zb(a, b, c) {
  ...
  function Ab(a, b, c) {
    if (a && (a.addEventListener || a.attachEvent)) {
      var d = zb(a, b, c);
      if (!d) {
        var d = ++yb.count + "", e = !("mouseenter" != b && "mouseleave" != b || !a.addEventListener || "onmouseenter" in document), f;
        f = e ? function (d) {
            d = new y(d);
            if (!ob(d.relatedTarget, function (b) {
                return b == a
  ...
  function Bb(a) {
    a && ("string" == typeof a && (a = [a]), D(a, function (a) {
      if (a in w) {
        var b = w[a], d = b[0], e = b[1], f = b[3], b = b[4];
  ...
  function S(a, b, c) {
    ...
    this.v = {};
    b = document;
    if (a = q(a) ? b.getElementById(a) : a)if ("iframe" != a.tagName.toLowerCase() && (b = Eb(this, a), this.h = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.a = a, this.a.id || (b = a = this.a, b = b[r] || (b[r] = ++ca), a.id = "widget" + b), Q[this.a.id] = this, window.postMessage) {
      this.f = new N;
      Fb(this);
      a = T(this.b, "events");
      for (var d in a)a.hasOwnProperty(d) && this.addEventListener(d, a[d]);
      for (var e in ub)Gb(this,
        e)
    }
  }
  ...
  function Eb(a, b) {
    ...
    l.widgetid = a.g;
    window.location.href && D(["debugjs", "debugcss"], function (a) {
      var b;
  ...
  W.prototype.g = function (a) {
    if (a.origin == T(this, "host") || a.origin == T(this, "host").replace(/^http:/, "https:")) {
      ...
      if (a = U[b.id]) a.B = !0, a.B && (D(a.w, a.C, a), a.w.length = 0), a.J(b)
    }
  };
  function Jb(a) {
    W.call(this, a);
    ...
    D(b, function (a) {
      this[a] || ("getCurrentTime" == a ? this[a] = function () {
          ...
          if (1 == this.j.playerState) {
            var b = (fa() / 1E3 - this.j.currentTimeLastUpdated_) * this.j.playbackRate;
            0 < b && (a += Math.min(b, 1))
          }
          return a
  ...
  g.V = function () {
    ...
    ua.test(b) && (-1 != b.indexOf("&") && (b = b.replace(oa, "&amp;")), -1 != b.indexOf("<") && (b = b.replace(pa, "&lt;")), -1 != b.indexOf(">") && (b = b.replace(qa, "&gt;")), -1 != b.indexOf('"') && (b = b.replace(ra, "&quot;")), -1 != b.indexOf("'") && (b = b.replace(sa, "&#39;")), -1 != b.indexOf("\x00") && (b = b.replace(ta, "&#0;")));
